...
var e=(0,eval)("this"),t=require("process");(function(t){var n,r,o,a,s,i,u,f,c,l,d,p,h,y,v,g,m,x,b,E,w,L,T,R,D,N,C=[].indexOf||function(e){for(var t=0,n=this.length;t<n;t++)if(t in this&&this[t]===e)return t;return-1};l=null,l="undefined"!=typeof WorkerGlobalScope&&self instanceof WorkerGlobalScope?self:void 0!==e?e:window,m=l.document,f="addEventListener",u="removeEventListener",o="dispatchEvent",y="XMLHttpRequest",c=["load","loadend","loadstart"],n=["progress","abort","error","timeout"],R="undefined"!=typeof navigator&&navigator.useragent?navigator.userAgent:"",E=parseInt((/msie (\d+)/.exec(R.toLowerCase())||[])[1]),isNaN(E)&&(E=parseInt((/trident\/.*; rv:(\d+)/.exec(R.toLowerCase())||[])[1])),(N=Array.prototype).indexOf||(N.indexOf=function(e){var t,n,r;for(t=n=0,r=this.length;n<r;t=++n)if(this[t]===e)return t;return-1}),T=function(e,t){return Array.prototype.slice.call(e,t)},g=function(e){return"returnValue"===e||"totalSize"===e||"position"===e},b=function(e,t){var n;for(n in e)if(e[n],!g(n))try{t[n]=e[n]}catch(e){}return t},w=function(e){return void 0===e?null:e},L=function(e,t,n){var r,a,s,i;for(a=function(e){return function(r){var a,s,i;for(s in a={},r)g(s)||(i=r[s],a[s]=i===t?n:i);return n[o](e,a)}},s=0,i=e.length;s<i;s++)r=e[s],n._has(r)&&(t["on"+r]=a(r))},x=function(e){var t;if(m&&null!=m.createEventObject)return(t=m.createEventObject()).type=e,t;try{return new Event(e)}catch(t){return{type:e}}},(D=(r=function(e){var n,r,a;return r={},a=function(e){return r[e]||[]},(n={})[f]=function(e,n,o){r[e]=a(e),r[e].indexOf(n)>=0||(o=o===t?r[e].length:o,r[e].splice(o,0,n))},n[u]=function(e,n){var o;e!==t?(n===t&&(r[e]=[]),-1!==(o=a(e).indexOf(n))&&a(e).splice(o,1)):r={}},n[o]=function(){var t,r,o,s,i,u,f;for(r=(t=T(arguments)).shift(),e||(t[0]=b(t[0],x(r))),(s=n["on"+r])&&s.apply(n,t),o=i=0,u=(f=a(r).concat(a("*"))).length;i<u;o=++i)f[o].apply(n,t)},n._has=function(e){return!(!r[e]&&!n["on"+e])},e&&(n.listeners=function(e){return T(a(e))},n.on=n[f],n.off=n[u],n.fire=n[o],n.once=function(e,t){var r;return r=function(){return n.off(e,r),t.apply(null,arguments)},n.on(e,r)},n.destroy=function(){return r={}}),n})(!0)).EventEmitter=r,D.before=function(e,t){if(e.length<1||e.length>2)throw"invalid hook";return D[f]("before",e,t)},D.after=function(e,t){if(e.length<2||e.length>3)throw"invalid hook";return D[f]("after",e,t)},D.enable=function(){l[y]=h,"function"==typeof d&&(l.fetch=d),s&&(l.FormData=p)},D.disable=function(){l[y]=D[y],l.fetch=D.fetch,s&&(l.FormData=s)},v=D.headers=function(e,t){var n,r,o,a,s,i,u,f,c;switch(null==t&&(t={}),typeof e){case"object":for(o in r=[],e)s=e[o],a=o.toLowerCase(),r.push(a+":\t"+s);return r.join("\n")+"\n";case"string":for(u=0,f=(r=e.split("\n")).length;u<f;u++)n=r[u],/([^:]+):\s*(.+)/.test(n)&&(a=null!=(c=RegExp.$1)?c.toLowerCase():void 0,i=RegExp.$2,null==t[a]&&(t[a]=i));return t}},s=l.FormData,p=function(e){var t,n;this.fd=e?new s(e):new s,this.form=e,t=[],Object.defineProperty(this,"entries",{get:function(){return(e?T(e.querySelectorAll("input,select")).filter(function(e){var t;return"checkbox"!==(t=e.type)&&"radio"!==t||e.checked}).map(function(e){return[e.name,"file"===e.type?e.files:e.value]}):[]).concat(t)}}),this.append=(n=this,function(){var e;return e=T(arguments),t.push(e),n.fd.append.apply(n.fd,e)})},s&&(D.FormData=s,l.FormData=p),i=l[y],D[y]=i,h=l[y]=function(){var e,t,a,s,i,u,l,d,h,g,m,x,T,R,N,O,S,A,k,H;S=new D[y],T=null,u=void 0,R=void 0,m=void 0,h=function(){var e,t,n,r;if(m.status=T||S.status,-1===T&&E<10||(m.statusText=S.statusText),-1!==T)for(e in r=v(S.getAllResponseHeaders()))n=r[e],m.headers[e]||(t=e.toLowerCase(),m.headers[t]=n)},d=function(){if(S.responseType&&"text"!==S.responseType)"document"===S.responseType?(m.xml=S.responseXML,m.data=S.responseXML):m.data=S.response;else{m.text=S.responseText,m.data=S.responseText;try{m.xml=S.responseXML}catch(e){}}"responseURL"in S&&(m.finalUrl=S.responseURL)},O=function(){i.status=m.status,i.statusText=m.statusText},N=function(){"text"in m&&(i.responseText=m.text),"xml"in m&&(i.responseXML=m.xml),"data"in m&&(i.response=m.data),"finalUrl"in m&&(i.responseURL=m.finalUrl)},a=function(n){for(;n>e&&e<4;)i.readyState=++e,1===e&&i[o]("loadstart",{}),2===e&&O(),4===e&&(O(),N()),i[o]("readystatechange",{}),4===e&&(!1===g.async?t():setTimeout(t,0))},t=function(){u||i[o]("load",{}),i[o]("loadend",{}),u&&(i.readyState=0)},e=0,x=function(e){var t,n;4===e?(t=D.listeners("after"),(n=function(){var e;return t.length?2===(e=t.shift()).length?(e(g,m),n()):3===e.length&&g.async?e(g,m,n):n():a(4)})()):a(e)},i=(g={}).xhr=r(),S.onreadystatechange=function(e){try{2===S.readyState&&h()}catch(e){}4===S.readyState&&(R=!1,h(),d()),x(S.readyState)},l=function(){u=!0},i[f]("error",l),i[f]("timeout",l),i[f]("abort",l),i[f]("progress",function(){e<3?x(3):i[o]("readystatechange",{})}),("withCredentials"in S||D.addWithCredentials)&&(i.withCredentials=!1),i.status=0;for(A=0,k=(H=n.concat(c)).length;A<k;A++)s=H[A],i["on"+s]=null;return i.open=function(t,n,r,o,a){e=0,u=!1,R=!1,g.headers={},g.headerNames={},g.status=0,(m={}).headers={},g.method=t,g.url=n,g.async=!1!==r,g.user=o,g.pass=a,x(1)},i.send=function(e){var t,r,o,a,s,u,f,l;for(u=0,f=(l=["type","timeout","withCredentials"]).length;u<f;u++)(o="type"===(r=l[u])?"responseType":r)in i&&(g[r]=i[o]);g.body=e,s=function(){var e,t,a,s,u,f;for(L(n,S,i),i.upload&&L(n.concat(c),S.upload,i.upload),R=!0,S.open(g.method,g.url,g.async,g.user,g.pass),a=0,s=(u=["type","timeout","withCredentials"]).length;a<s;a++)o="type"===(r=u[a])?"responseType":r,r in g&&(S[o]=g[r]);for(e in f=g.headers)t=f[e],e&&S.setRequestHeader(e,t);g.body instanceof p&&(g.body=g.body.fd),S.send(g.body)},t=D.listeners("before"),(a=function(){var e,n;return t.length?((e=function(e){if("object"==typeof e&&("number"==typeof e.status||"number"==typeof m.status))return b(e,m),C.call(e,"data")<0&&(e.data=e.response||e.text),void x(4);a()}).head=function(e){return b(e,m),x(2)},e.progress=function(e){return b(e,m),x(3)},1===(n=t.shift()).length?e(n(g)):2===n.length&&g.async?n(g,e):e()):s()})()},i.abort=function(){T=-1,R?S.abort():i[o]("abort",{})},i.setRequestHeader=function(e,t){var n,r;n=null!=e?e.toLowerCase():void 0,r=g.headerNames[n]=g.headerNames[n]||e,g.headers[r]&&(t=g.headers[r]+", "+t),g.headers[r]=t},i.getResponseHeader=function(e){var t;return t=null!=e?e.toLowerCase():void 0,w(m.headers[t])},i.getAllResponseHeaders=function(){return w(v(m.headers))},S.overrideMimeType&&(i.overrideMimeType=function(){return S.overrideMimeType.apply(S,arguments)}),S.upload&&(i.upload=g.upload=r()),i.UNSENT=0,i.OPENED=1,i.HEADERS_RECEIVED=2,i.LOADING=3,i.DONE=4,i.response="",i.responseText="",i.responseXML=null,i.readyState=0,i.statusText="",i},"function"==typeof l.fetch&&(a=l.fetch,D.fetch=a,d=l.fetch=function(e,t){var n,r,o;return null==t&&(t={headers:{}}),t.url=e,o=null,r=D.listeners("before"),n=D.listeners("after"),new Promise(function(e,s){var i,u,f,c,l;u=function(){return t.body instanceof p&&(t.body=t.body.fd),t.headers&&(t.headers=new Headers(t.headers)),o||(o=new Request(t.url,t)),b(t,o)},f=function(t){var r;return n.length?2===(r=n.shift()).length?(r(u(),t),f(t)):3===r.length?r(u(),t,f):f(t):e(t)},i=function(t){var n;if(void 0!==t)return n=new Response(t.body||t.text,t),e(n),void f(n);c()},c=function(){var e;if(r.length)return 1===(e=r.shift()).length?i(e(t)):2===e.length?e(u(),i):void 0;l()},l=function(){return a(u()).then(function(e){return f(e)}).catch(function(e){return f(e),s(e)})},c()})}),h.UNSENT=0,h.OPENED=1,h.HEADERS_RECEIVED=2,h.LOADING=3,h.DONE=4,"function"==typeof define&&define.amd?define("xhook",[],function(){return D}):"object"==typeof module&&module.exports?module.exports={xhook:D}:l&&(l.xhook=D)}).call(this);
