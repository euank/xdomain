...
var e=(0,eval)("this"),t=require("process");(function(t,n){var r,o,a,s,i,u,f,c,l,d,p,h,y,v,g,m,x,b,E,w,L,T,R,D,N,C,O=[].indexOf||function(e){for(var t=0,n=this.length;t<n;t++)if(t in this&&this[t]===e)return t;return-1};d=null,d="undefined"!=typeof WorkerGlobalScope&&self instanceof WorkerGlobalScope?self:void 0!==e?e:t,x=d.document,c="addEventListener",f="removeEventListener",a="dispatchEvent",v="XMLHttpRequest",l=["load","loadend","loadstart"],r=["progress","abort","error","timeout"],D="undefined"!=typeof navigator&&navigator.useragent?navigator.userAgent:"",w=parseInt((/msie (\d+)/.exec(D.toLowerCase())||[])[1]),isNaN(w)&&(w=parseInt((/trident\/.*; rv:(\d+)/.exec(D.toLowerCase())||[])[1])),(C=Array.prototype).indexOf||(C.indexOf=function(e){var t,n,r;for(t=n=0,r=this.length;n<r;t=++n)if(this[t]===e)return t;return-1}),R=function(e,t){return Array.prototype.slice.call(e,t)},m=function(e){return"returnValue"===e||"totalSize"===e||"position"===e},E=function(e,t){var n;for(n in e)if(e[n],!m(n))try{t[n]=e[n]}catch(e){}return t},L=function(e){return void 0===e?null:e},T=function(e,t,n){var r,o,s,i;for(o=function(e){return function(r){var o,s,i;for(s in o={},r)m(s)||(i=r[s],o[s]=i===t?n:i);return n[a](e,o)}},s=0,i=e.length;s<i;s++)r=e[s],n._has(r)&&(t["on"+r]=o(r))},b=function(e){var t;if(x&&null!=x.createEventObject)return(t=x.createEventObject()).type=e,t;try{return new Event(e)}catch(t){return{type:e}}},(N=(o=function(e){var t,r,o;return r={},o=function(e){return r[e]||[]},(t={})[c]=function(e,t,a){r[e]=o(e),r[e].indexOf(t)>=0||(a=a===n?r[e].length:a,r[e].splice(a,0,t))},t[f]=function(e,t){var a;e!==n?(t===n&&(r[e]=[]),-1!==(a=o(e).indexOf(t))&&o(e).splice(a,1)):r={}},t[a]=function(){var n,r,a,s,i,u,f;for(r=(n=R(arguments)).shift(),e||(n[0]=E(n[0],b(r))),(s=t["on"+r])&&s.apply(t,n),a=i=0,u=(f=o(r).concat(o("*"))).length;i<u;a=++i)f[a].apply(t,n)},t._has=function(e){return!(!r[e]&&!t["on"+e])},e&&(t.listeners=function(e){return R(o(e))},t.on=t[c],t.off=t[f],t.fire=t[a],t.once=function(e,n){var r;return r=function(){return t.off(e,r),n.apply(null,arguments)},t.on(e,r)},t.destroy=function(){return r={}}),t})(!0)).EventEmitter=o,N.before=function(e,t){if(e.length<1||e.length>2)throw"invalid hook";return N[c]("before",e,t)},N.after=function(e,t){if(e.length<2||e.length>3)throw"invalid hook";return N[c]("after",e,t)},N.enable=function(){d[v]=y,"function"==typeof p&&(d.fetch=p),i&&(d.FormData=h)},N.disable=function(){d[v]=N[v],d.fetch=N.fetch,i&&(d.FormData=i)},g=N.headers=function(e,t){var n,r,o,a,s,i,u,f,c;switch(null==t&&(t={}),typeof e){case"object":for(o in r=[],e)s=e[o],a=o.toLowerCase(),r.push(a+":\t"+s);return r.join("\n")+"\n";case"string":for(u=0,f=(r=e.split("\n")).length;u<f;u++)n=r[u],/([^:]+):\s*(.+)/.test(n)&&(a=null!=(c=RegExp.$1)?c.toLowerCase():void 0,i=RegExp.$2,null==t[a]&&(t[a]=i));return t}},i=d.FormData,h=function(e){var t,n;this.fd=e?new i(e):new i,this.form=e,t=[],Object.defineProperty(this,"entries",{get:function(){return(e?R(e.querySelectorAll("input,select")).filter(function(e){var t;return"checkbox"!==(t=e.type)&&"radio"!==t||e.checked}).map(function(e){return[e.name,"file"===e.type?e.files:e.value]}):[]).concat(t)}}),this.append=(n=this,function(){var e;return e=R(arguments),t.push(e),n.fd.append.apply(n.fd,e)})},i&&(N.FormData=i,d.FormData=h),u=d[v],N[v]=u,y=d[v]=function(){var e,t,n,s,i,u,f,d,p,y,m,x,b,R,D,C,S,A,k,H;S=new N[v],b=null,u=void 0,R=void 0,m=void 0,p=function(){var e,t,n,r;if(m.status=b||S.status,-1===b&&w<10||(m.statusText=S.statusText),-1!==b)for(e in r=g(S.getAllResponseHeaders()))n=r[e],m.headers[e]||(t=e.toLowerCase(),m.headers[t]=n)},d=function(){if(S.responseType&&"text"!==S.responseType)"document"===S.responseType?(m.xml=S.responseXML,m.data=S.responseXML):m.data=S.response;else{m.text=S.responseText,m.data=S.responseText;try{m.xml=S.responseXML}catch(e){}}"responseURL"in S&&(m.finalUrl=S.responseURL)},C=function(){i.status=m.status,i.statusText=m.statusText},D=function(){"text"in m&&(i.responseText=m.text),"xml"in m&&(i.responseXML=m.xml),"data"in m&&(i.response=m.data),"finalUrl"in m&&(i.responseURL=m.finalUrl)},n=function(n){for(;n>e&&e<4;)i.readyState=++e,1===e&&i[a]("loadstart",{}),2===e&&(p(),C()),4===e&&(C(),D()),i[a]("readystatechange",{}),4===e&&(!1===y.async?t():setTimeout(t,0))},t=function(){u||i[a]("load",{}),i[a]("loadend",{}),u&&(i.readyState=0)},e=0,x=function(e){var t,r;4===e?(t=N.listeners("after"),(r=function(){var e;return t.length?2===(e=t.shift()).length?(e(y,m),r()):3===e.length&&y.async?e(y,m,r):r():n(4)})()):n(e)},i=(y={}).xhr=o(),S.onreadystatechange=function(e){try{2===S.readyState&&p()}catch(e){}4===S.readyState&&(R=!1,p(),d()),x(S.readyState)},f=function(){u=!0},i[c]("error",f),i[c]("timeout",f),i[c]("abort",f),i[c]("progress",function(){e<3?x(3):i[a]("readystatechange",{})}),("withCredentials"in S||N.addWithCredentials)&&(i.withCredentials=!1),i.status=0;for(A=0,k=(H=r.concat(l)).length;A<k;A++)s=H[A],i["on"+s]=null;return i.open=function(t,n,r,o,a){e=0,u=!1,R=!1,y.headers={},y.headerNames={},y.status=0,(m={}).headers={},y.method=t,y.url=n,y.async=!1!==r,y.user=o,y.pass=a,x(1)},i.send=function(e){var t,n,o,a,s,u,f,c;for(u=0,f=(c=["type","timeout","withCredentials"]).length;u<f;u++)(o="type"===(n=c[u])?"responseType":n)in i&&(y[n]=i[o]);y.body=e,s=function(){var e,t,a,s,u,f;for(T(r,S,i),i.upload&&T(r.concat(l),S.upload,i.upload),R=!0,S.open(y.method,y.url,y.async,y.user,y.pass),a=0,s=(u=["type","timeout","withCredentials"]).length;a<s;a++)o="type"===(n=u[a])?"responseType":n,n in y&&(S[o]=y[n]);for(e in f=y.headers)t=f[e],e&&S.setRequestHeader(e,t);y.body instanceof h&&(y.body=y.body.fd),S.send(y.body)},t=N.listeners("before"),(a=function(){var e,n;return t.length?((e=function(e){if("object"==typeof e&&("number"==typeof e.status||"number"==typeof m.status))return E(e,m),O.call(e,"data")<0&&(e.data=e.response||e.text),void x(4);a()}).head=function(e){return E(e,m),x(2)},e.progress=function(e){return E(e,m),x(3)},1===(n=t.shift()).length?e(n(y)):2===n.length&&y.async?n(y,e):e()):s()})()},i.abort=function(){b=-1,R?S.abort():i[a]("abort",{})},i.setRequestHeader=function(e,t){var n,r;n=null!=e?e.toLowerCase():void 0,r=y.headerNames[n]=y.headerNames[n]||e,y.headers[r]&&(t=y.headers[r]+", "+t),y.headers[r]=t},i.getResponseHeader=function(e){var t;return t=null!=e?e.toLowerCase():void 0,L(m.headers[t])},i.getAllResponseHeaders=function(){return L(g(m.headers))},S.overrideMimeType&&(i.overrideMimeType=function(){return S.overrideMimeType.apply(S,arguments)}),S.upload&&(i.upload=y.upload=o()),i.UNSENT=0,i.OPENED=1,i.HEADERS_RECEIVED=2,i.LOADING=3,i.DONE=4,i.response="",i.responseText="",i.responseXML=null,i.readyState=0,i.statusText="",i},"function"==typeof d.fetch&&(s=d.fetch,N.fetch=s,p=d.fetch=function(e,t){var n,r,o;return null==t&&(t={headers:{}}),t.url=e,o=null,r=N.listeners("before"),n=N.listeners("after"),new Promise(function(e,a){var i,u,f,c,l;u=function(){return t.body instanceof h&&(t.body=t.body.fd),t.headers&&(t.headers=new Headers(t.headers)),o||(o=new Request(t.url,t)),E(t,o)},f=function(t){var r;return n.length?2===(r=n.shift()).length?(r(u(),t),f(t)):3===r.length?r(u(),t,f):f(t):e(t)},i=function(t){var n;if(void 0!==t)return n=new Response(t.body||t.text,t),e(n),void f(n);c()},c=function(){var e;if(r.length)return 1===(e=r.shift()).length?i(e(t)):2===e.length?e(u(),i):void 0;l()},l=function(){return s(u()).then(function(e){return f(e)}).catch(function(e){return f(e),a(e)})},c()})}),y.UNSENT=0,y.OPENED=1,y.HEADERS_RECEIVED=2,y.LOADING=3,y.DONE=4,"function"==typeof define&&define.amd?define("xhook",[],function(){return N}):"object"==typeof module&&module.exports?module.exports={xhook:N}:d&&(d.xhook=N)}).call(this,window);
...
Array.from||(Array.from=require("array.from").getPolyfill());var r=require("xhook").xhook;window.xhook=r;var o=require("./index");window.xdomain=o;
